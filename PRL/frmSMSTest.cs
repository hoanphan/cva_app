...
namespace PRL
{
    public partial class frmSMSTest : Form
    {
        mCore.SMS objSMS = new mCore.SMS();
        string strMyAppName = "mCore™ (C# Demo)";
        ...
        private void frmSMSTest_FormClosed(object sender, FormClosedEventArgs e)
        {
            objSMS.Dispose();
            objSMS = null;
        }

        private void frmSMSTest_Load(object sender, EventArgs e)
        {
            int i;
