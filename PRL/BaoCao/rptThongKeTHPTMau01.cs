...
namespace PRL
{
    public partial class rptThongKeTHPTMau01 : DevExpress.XtraReports.UI.XtraReport
    {
        public rptThongKeTHPTMau01(string maHocKy)
        {
            InitializeComponent();
            generateTable();
            if (maHocKy == "K1")
            ...
            this.DataSource = ThongKeBLL.ThongKeDiemHocKyTHCS(maHocKy,false);
        }
